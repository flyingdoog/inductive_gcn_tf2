...
args.add_argument('--dataset', default='pubmed', help='citeseer, cora, pubmed') #cora, citeseer,
args.add_argument('--model', default='gcn')
args.add_argument('--learning_rate', default=0.005)
args.add_argument('--epochs', default=3000)
args.add_argument('--hidden1', default=256)
...
args.add_argument('--train_batch_size', default=128)
args.add_argument('--test_batch_size', default=128)
args.add_argument('--val_batch_size', default=128)
